...
function Main()
   ...
   oBrw:bKeyDown = { | nKey | If( nKey == 32, ( aTest[ oBrw:nArrayAt ][ 1 ] := ! aTest[ oBrw:nArrayAt ][ 1 ], oBrw:Refresh() ),) }

   oBrw:bLClicked = { | nRowAt, nCol | If( nCol < 80, ( aTest[ oBrw:nArrayAt ][ 1 ]:= ! aTest[ oBrw:nArrayAt ][ 1 ], oBrw:Refresh() ),) }   
